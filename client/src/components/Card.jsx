...
export default function Card({konten, handleDelete}) {
  const update = {
    pathname: `/edit/${konten.mataPelajaran}/${konten.materi}/${konten.subMateri}/${konten.kode}`,
  }
  return(
    <div className='font-poppins flex flex-col gap-5 bg-white xl:grid grid-cols-4 xl:gap-10 rounded-2xl p-4 m-5'>
